...
export const registerUiComponents = (container: Container) => {
	...
	container
		.bind(IExtensionContribution)
		.to(LongPredictionUI)
		.inSingletonScope();
	container.bind(IExtensionContribution).to(DebugLinkUi).inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(CascadeTerminationTracker)
		.inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(DisableSourceMapUI)
		.inSingletonScope();
	container.bind(IExtensionContribution).to(DiagnosticsUI).inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(StartDebugingAndStopOnEntry)
		.inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(JsDebugPortAttributesProvider)
		.inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(EdgeDevToolOpener)
		.inSingletonScope();
	container
		.bind(IExtensionContribution)
		.to(ExcludedCallersUI)
		.inSingletonScope();
	...
	container
		...
		.inSingletonScope();
	container
		.bind(ILinkedBreakpointLocation)
		.to(LinkedBreakpointLocationUI)
		.inSingletonScope();
	container
...
export const registerTopLevelSessionComponents = (container: Container) => {
	...
	container
		...
		.to(SettingRequestOptionsProvider)
		.inSingletonScope();

	container
		.bind(IExperimentationService)
		.to(VSCodeExperimentationService)
		.inSingletonScope();
};
