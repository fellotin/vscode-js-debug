	...
	describe("simplify", () => {
		it("should merge overlapping ranges", () => {
			const range1 = new Range(
				...
				new Base0Position(0, 5)
			);
			const range2 = new Range(
				new Base0Position(0, 3),
				new Base0Position(0, 8)
			);
			const range3 = new Range(
				new Base0Position(0, 10),
				new Base0Position(0, 15)
			);
			const range4 = new Range(
				new Base0Position(0, 12),
				new Base0Position(0, 20)
			);
			const range5 = new Range(
				new Base0Position(0, 25),
				new Base0Position(0, 30)
			);
			const range6 = new Range(
				new Base0Position(0, 28),
				new Base0Position(0, 35)
			);
