...
export const namedSocketDirectory =
 ...
 */
export const isWithinAsar = (filePath: string) =>
	filePath.includes(`.asar${path.sep}`);
 ...
 */
export const isWindowsPath = (path: string) =>
	/^[A-Za-z]:/.test(path) || isUncPath(path);
