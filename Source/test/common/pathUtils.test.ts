...
describe("pathUtils", () => {
	...
	describe("fixDriveLetterAndSlashes", () => {
		it("works for c:/... cases", () => {
			expect(fixDriveLetterAndSlashes("C:/path/stuff")).to.equal(
				"c:\\path\\stuff"
			);
			expect(fixDriveLetterAndSlashes("c:/path\\stuff")).to.equal(
				"c:\\path\\stuff"
		...
		it("works for file:/// cases", () => {
			...
			expect(fixDriveLetterAndSlashes("file:///C:\\path")).to.equal(
				"file:///c:\\path"
			);
			expect(fixDriveLetterAndSlashes("file:///C:\\")).to.equal(
				"file:///c:\\"
			);
		});

		it("does not impact posix cases", () => {
			expect(fixDriveLetterAndSlashes("file:///a/b")).to.equal(
				"file:///a/b"
			);
