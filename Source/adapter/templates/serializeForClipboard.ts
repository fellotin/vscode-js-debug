 ...
 */
export const serializeForClipboardTmpl = templateFunction(
	(valueToStringify: unknown, spaces: number) => {
			...
			switch (typeof value) {
				...
				case "object":
					...
					if (
						...
						valueToStringify instanceof Node
					) {
