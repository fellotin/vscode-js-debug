...
*/
				...
				function addStylesClient(
					...
					return function update(newList) {
						...
						if (newList) {
							styles = Object(
								_listToStyles__WEBPACK_IMPORTED_MODULE_0__[
									"default"
								]
							)(parentId, newList);
							addStylesToDom(styles);
				...
				function addStyle(obj /* StyleObjectPart */) {
					...
					if (isOldIE) {
						...
						styleElement =
							singletonElement ||
							(singletonElement = createStyleElement());
				...
				function applyToSingletonTag(styleElement, index, remove, obj) {
					...
					if (styleElement.styleSheet) {
						styleElement.styleSheet.cssText = replaceText(
							index,
							css
						);
					} else {
					...
					var Transition = {
						...
						render: function render(h) {
							...
							if (
								...
								var oldData = (oldChild.data.transition =
									extend({}, data));
					...
					var TransitionGroup = {
						...
						beforeMount: function beforeMount() {
							...
							this._update = function (vnode, hydrating) {
								var restoreActiveInstance =
									setActiveInstance(this$1);
								// force removing pass
								this$1.__patch__(
									this$1._vnode,
									this$1.kept,
